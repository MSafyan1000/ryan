          ...
          <div className="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
            ...
            <div className="d-none d-md-block">
              <button className="btn btn-sm pd-x-15 btn-white btn-uppercase">
                <i data-feather="mail" className="wd-10 mg-r-5" /> Email
              </button>
              <button className="btn btn-sm pd-x-15 btn-white btn-uppercase mg-l-5">
                <i data-feather="printer" className="wd-10 mg-r-5" /> Print
              </button>
              <button className="btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5">
                <i data-feather="file" className="wd-10 mg-r-5" /> Generate
                Report
              </button>
            </div>
          </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-sm-5 mg-t-20 mg-sm-t-0">
                        ...
                        <p className="mg-b-0 tx-12 tx-color-03">
                          ...
                          yearly basis. <a href="#">Learn More</a>
                        </p>
                      </div>
                      {/* col */}
                    </div>
              ...
              <div className="card ht-100p">
                <div className="card-header d-flex align-items-center justify-content-between">
                  ...
                  <div className="d-flex tx-18">
                    ...
                    <a href="#" className="link-03 lh-0 mg-l-10">
                ...
                <ul className="list-group list-group-flush tx-13">
                  ...
                  <li className="list-group-item d-flex pd-sm-x-20">
                    ...
                    <div className="mg-l-auto text-right">
                      ...
                      <small className="tx-12 tx-info mg-b-0">For pickup</small>
                    </div>
                  </li>
                  <li className="list-group-item d-flex pd-sm-x-20">
                    <div className="avatar d-none d-sm-block">
                  ...
                  <li className="list-group-item d-flex pd-sm-x-20">
                    ...
                    <div className="mg-l-auto text-right">
                      ...
                      <small className="tx-12 tx-danger mg-b-0">Declined</small>
                    </div>
                  </li>
                </ul>
                  ...
                  <li className="list-group-item d-flex pd-sm-x-20">
                    ...
                    <div className="mg-l-auto d-flex align-self-center">
                      <nav className="nav nav-icon-only">
                        ...
                        <a href="#" className="nav-link d-sm-none">
